...
def customer_spend_df(df):
    ...
    # Mengurutkan DataFrame berdasarkan kolom kategorikal
    sorted_df = sum_spend_df.sort_values(by='month_cat')

    # Hapus kolom 'month_cat' jika Anda tidak membutuhkannya
...
with st.sidebar:
    ...
    st.write('Copyright (C) © 2023 by Rizky Irfan Sulthoni ')
